 ...
 *  Andreas Aronsson, pk01-14, Franz Hänel, pk01-26  den 6 december 2001
 *  @author Aron&Franz
 *  @version 1.1
 */
...
public class Artikel {
    ...
    protected double aPris, bestPkt, lagerMgd;
    protected String varuNamn, enhet, eanKod;
    Artikel next;
    /**
     ...
     */
    public Artikel (String nyEanKod, double  nyMgd) {
	eanKod=nyEanKod;
	lagerMgd=nyMgd;
    }
    /**
